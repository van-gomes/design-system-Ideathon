...
import { require_semver, require_compare, require_gte, require_re, require_parse_options, require_debug, require_constants, require_identifiers, storeOptions, TEST_PROVIDER_ID, COVERAGE_DIRECTORY, ADDON_ID } from '../chunk-L5YETAHB.mjs';
